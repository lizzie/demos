define(function (require, exports, module) {
    ...
    OpenLayers.Layer.MyLayer = OpenLayers.Class(OpenLayers.Layer.Grid, {
         ...
         * Example:
         * (code)
         *     var layer = new OpenLayers.Layer.MyLayer(
         *         "My Layer",
        ...
        _getBlockIndexStr:function (dLongitude, dLatitude, nZoom) {
            var rtVal = "";
            var IndexH = dLongitude;//this._getLongitudeIndex(dLongitude, nZoom);//水平方向索引
            var IndexV = dLatitude;//this._getLatitudeIndex(dLatitude, nZoom);//垂直方向索引
            ...
            //console.log(dLongitude +", " + dLatitude + ", " + IndexH + ", " + IndexV + ", " + rtVal);
        ...
        getURL:function (bounds) {
            ...
            var block_index = this._getBlockIndexStr(x, y, z);///this._getBlockIndexStr(centerLonLat.lon, centerLonLat.lat, z);
            var url = this.url;
            ...
            //console.log("x: " + x + ", y: " + y + ", z: " + z + ", centerLonLat.lon: " + centerLonLat.lon + ", centerLonLat.lat:" + centerLonLat.lat);
